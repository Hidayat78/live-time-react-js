        ...
        <div>
            <nav className="navbar navbar-expand-lg bg-body-tertiary bg-primary">
                <div className="container-fluid">
                    <a className="navbar-brand text-white" href="#">Mr. Morning Star</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <a className="nav-link text-light" href="#">Hidayat</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link text-light disabled">Lets Go</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link text-light disabled">Contact</a>
                            </li>
                        </ul>
                        <form className="d-flex" role="search">
                            <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search" />
                            <button className="btn btn-outline-success bg-danger text-light" type="submit">Search</button>
                        </form>
                    </div>
                </div>
            </nav>
            ...
            <div id="carouselExampleIndicators" className="carousel slide">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={pic2} height="500px" width="100%" />
                    </div>
                    <div className="carousel-item">
                        <img src={pic2} height="500px" width="100%" />
                    </div>
                    <div className="carousel-item">
                        <img src={pic3} height="500px" width="100%" />
                    </div>
                </div>
            ...
            <h2 className="backgrnd mt-1">Services</h2>
            <div className="col">
                <div className="col-xxl-2 col-xl-2 col-lg-3 col-md-4 col-sm-6">
                    <div className="card">
                        <img src={pic2} height="250px" class="card-img-top" />
